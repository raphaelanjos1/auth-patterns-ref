...
- [ ] No repository merge; password projection rules preserved
- [ ] Service specs mock ports
- [ ] Gate: `npm test`
...
- [ ] Decision recorded with rationale and next steps
